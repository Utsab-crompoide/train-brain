  ...
  return (
    <div
      className={`flex items-center justify-between rounded-xl px-5 py-4 border transition-all duration-500
        ${revealed ? "border-gray-700 bg-gray-800/60" : "border-gray-800 bg-gray-900/40"}
      ...
      {Array.from({ length: total }).map((_, i) => (
        <div
          ...
          className={`h-2 w-8 rounded-full transition-all duration-300 ${
            i < revealed ? "bg-indigo-500" : "bg-gray-700"
          }`}
        />
      ))}
    </div>
    ...
    <div className="flex min-h-screen flex-col items-center bg-gray-950 font-sans">
      <main className="flex w-full max-w-lg flex-col px-5 py-12 sm:px-8">
        ...
        <div className="mb-6">
          ...
          <ProgressDots total={game.puzzle.words.length} revealed={game.revealedCount} />
        </div>
        ...
        {game.hintsRevealed > 0 && (
          <div className="mb-6 flex flex-col items-center gap-3">
            ...
            <HintBoxes answer={game.puzzle.answer} hintsRevealed={game.hintsRevealed} />
          </div>
        )}
          ...
          <div className="flex flex-col gap-3 mb-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-2xl bg-gray-800 hover:bg-gray-700 disabled:bg-gray-900 disabled:text-gray-700 disabled:cursor-not-allowed text-gray-300 font-semibold px-5 py-4 text-xs tracking-wide transition-all duration-200 active:scale-95 whitespace-nowrap"
              >
